...
![Drift Type](https://img.shields.io/badge/Drift-Infinite_Self_Correction-purple)
![Output Length](https://img.shields.io/badge/Output-Infinite-black)
...
1.  **Universal Firmware is Valid:** You do not need separate Root/Node firmware.
2.  **Automatic Election:** Use `esp_mesh_lite_start()` and the nodes will self-organize based on RSSI.
3.  **Hardware:** ESP32-S3 is the recommended hardware for this stack.
